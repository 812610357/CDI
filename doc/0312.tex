...
\begin{frame}
    \begin{figure}
        \subfigure{\includegraphics[height=6cm]{images/41586_2010_Article_BFnature09419_Fig1_HTML.png}}
        \qquad
        \subfigure{\includegraphics[height=6cm]{images/41586_2010_Article_BFnature09419_Fig2_HTML.png}}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{figure}
        \subfigure{\includegraphics[height=5.8cm]{images/41928_2019_309_Fig1_HTML.png}}
        \subfigure{\includegraphics[height=5.8cm]{images/X.png}}
    \end{figure}
\end{frame}
